...
public class login_alu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Acceso para el alumno");
        ...
        txt_matricula.setBackground(new java.awt.Color(204, 204, 204));
        txt_matricula.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txt_matricula, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new registrar_alumno(null, true, 1).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(login_alu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void ingresar() {
        ...
        if (!nombre.equals("") && !matricula.equals("")) {
            String respuesta = opc.accesoAlumno(Integer.parseInt(matricula), nombre);
            if (respuesta.equals("Correcto")) {
                JOptionPane.showMessageDialog(rootPane, "¡Bienvenido " + nombre + "!");
                new principal(2, Integer.parseInt(matricula)).setVisible(true);
                this.dispose();
            } else if (respuesta.equals("Mal")) {
                JOptionPane.showMessageDialog(rootPane, "El nombre o matrícula son incorrectos\n por favor verifique sus datos");
            } else {
                JOptionPane.showMessageDialog(rootPane, respuesta);
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Favor de ingresar los datos correspondiente ");
        }
    }
}
